...
| **`netflix-clone`** | Netflix Clone | Framer Motion, React Query | 영화/TV 시리즈 목록 조회 및 상세 정보, 검색 기능이 포함된 클론 코딩 |
...
| **`animation`** | Animation Practice | Framer Motion | 제스처, 레이아웃 전환 등 다양한 UI 애니메이션 실습 |
